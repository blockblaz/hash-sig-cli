...
use leansig::signature::{
    generalized_xmss::instantiations_aborting::lifetime_2_to_the_32::SchemeAbortingTargetSumLifetime32Dim46Base8,
    SignatureScheme,
};
...
fn generate_keys(
    ...
    for i in 0..num_validators {
        ...
        let (proposer_pk, proposer_sk) = SchemeAbortingTargetSumLifetime32Dim46Base8::key_gen(
            &mut rng,
            0,
            activation_duration,
        );
        ...
        let (attester_pk, attester_sk) = SchemeAbortingTargetSumLifetime32Dim46Base8::key_gen(
            &mut rng,
            0,
            activation_duration,
        );
...
fn create_validator_manifest(
    ...
    writeln!(manifest_file, "key_scheme: SchemeAbortingTargetSumLifetime32Dim46Base8")?;
